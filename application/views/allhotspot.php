...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Hotspot</a></li>
                        <li class="breadcrumb-item active">Add Hotspot Users</li>
                    </ol>
                </div>
                <h4 class="page-title">Hotspot online Users</h4>
    ...
    <div class="col-md-11 col-sm-11 col-xs-11 rightSideWrapper">
        ...
        <!-- Modal -->  <div class="modal fade" id="addhotspotUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
