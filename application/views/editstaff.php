                    ...
                    <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php foreach ($singleStaff as $row) : ?>
                                        <form role="form" id="addUser" enctype="multipart/form-data"action="<?php echo base_url() ?>staff/update" method="post" role="form">
                                        <input type="hidden" name="id" value="<?php echo $row->id; ?>">
                                        
                                        <div class="form-group row">
                                                <label for="horizontalInput1" class="col-sm-2 col-form-label">Full Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="horizontalInput1" placeholder="Name"value="<?php echo $row->name; ?>"  name="name" maxlength="128" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="horizontalInput1" placeholder="Mobile" id="mobile" value="<?php echo $row->mobile; ?>" name="mobile" maxlength="10"required>
                                                </div>
                                            </div>
