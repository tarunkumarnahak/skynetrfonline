...
<div class="page-content">
                ...
                <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title mt-0">Update Area</h4>
                                    ...
                                    <div class="form-material">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Area Name"name="name" id="mdate"name="createdate" value="<?php echo $row->name; ?>"required>
                                        
                                        <br>
                                        <button id="send"class="btn btn-primary" type="submit">Update Area Now</button>
                                    </div>       
                                </div><!--end card-body-->
                            </div><!--end card-->                                
                        </div> <!-- end col -->
