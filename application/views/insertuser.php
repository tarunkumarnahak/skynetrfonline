...
<div class="container-fluid">
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Staff/Users</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Users</a></li>
                        <li class="breadcrumb-item active">Quick Add Users</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Insert the Details about the users</h4>
                    <!-- <p class="text-muted mb-3">A powerful jQuery wizard plugin that
                        supports accessibility and HTML5</p> -->

                    <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>user/insert" accept-charset="utf-8">
                        <h3>Personal Infromation</h3>
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtFirstNameBilling" class="col-lg-3 col-form-label"></label>
                                        <div class="col-lg-9">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form-vertical" action=""class="form-horizontal form-wizard-wrapper">                                        
